...
type Data interface {
	StaticValidateReferences(ctx context.Context, refs []*addrs.Reference, self addrs.Referenceable, source addrs.Referenceable) hcl.Diagnostics

	GetCountAttr(context.Context, addrs.CountAttr, hcl.Range) (cty.Value, hcl.Diagnostics)
	GetForEachAttr(context.Context, addrs.ForEachAttr, hcl.Range) (cty.Value, hcl.Diagnostics)
	GetLocalValue(context.Context, addrs.LocalValue, hcl.Range) (cty.Value, hcl.Diagnostics)
	GetPathAttr(context.Context, addrs.PathAttr, hcl.Range) (cty.Value, hcl.Diagnostics)
	GetTerraformAttr(context.Context, addrs.TerraformAttr, hcl.Range) (cty.Value, hcl.Diagnostics)
	GetInputVariable(context.Context, addrs.InputVariable, hcl.Range) (cty.Value, hcl.Diagnostics)
}
